...
description: 'PdfItDown offers a modern CLI application to convert your files without never leaving your terminal'
---
...
Based on [typer](https://typer.tiangolo.com), the CLI is designed to offer a seamless experience, with almost as much control of inputs and outputs as if you were to write the flow in python: it is then the perfect choice if you want an easy and intuitive approach to file conversion, without getting your hands dirty with code.
