    ...
    for c in test_cases:
        ...
        try:
            result = converter.convert(
                file_path=c["file_input"], output_path=c["file_output"]
            )
...
def test_multiple_files():
    test_cases = [
        {
            ...
            "file_output": [
                "tests/data/test0_1.pdf",
                "tests/data/test_1.pdf",
                "tests/data/test2_1.pdf",
            ],
    ...
    for c in test_cases:
        print(c["test_name"])
        try:
            result = converter.multiple_convert(
                file_paths=c["file_input"], output_paths=c["file_output"]
            )
...
def test_dir():
    ...
    for c in test_cases:
        ...
        try:
            ...
            assert [pathlib.Path(r).is_file() for r in c["file_output"]] == c[
                "expected"
            ]
